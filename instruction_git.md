...
При возникновении конфликта, Git предлагает варианты его решения, нужно выбрать подходящий вариант автоматического изменения или внести изменения вручную.